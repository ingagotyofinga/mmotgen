# This code was written to get an idea of how this model architecture
# performed with a more standard loss function (MSE) instead of the W2*Kernel loss.
# This is almost like the heuristic.
# It also is a model for the simplest one d gaussian case.
# tuned model: SGD optimizer, lr = 0.01, batch_size = 1
# There was a large generalization gap until the sample sizes increased.
# It performs worse than our simple
...
# Create animation
def animate_distributions(source_sample, target_sample, predictions_over_epochs, title):
...
# Generate animations
train_animation = animate_distributions(train_source_sample, train_target_sample, train_predictions_over_epochs,
                                        'Evolution of Train Distributions')
test_animation = animate_distributions(test_source_sample, test_target_sample, test_predictions_over_epochs,
                                       'Evolution of Test Distributions')

# Save animations
train_animation.save('train_animation_1dGaussOTLoss.gif', writer='imagemagick')
test_animation.save('test_animation_1dGaussOTLoss.gif', writer='imagemagick')
